...
CardClass = {}
 ...
 function CardClass:new(xPos, yPos, Suite, Rank, Color, Flipped)
   local cardClass = {}
    ...
    cardClass.spade = love.graphics.newImage("spade.jpeg")
    cardClass.heart = love.graphics.newImage("heart.jpeg")
    cardClass.club = love.graphics.newImage("club.jpeg")
    cardClass.diamond = love.graphics.newImage("diamond.jpeg")
