...
function StackClass:new(xPos, yPos, Length, Height, stackType)
  ...
  stackClass.spade = love.graphics.newImage("assets/spade.jpeg")
  stackClass.heart = love.graphics.newImage("assets/heart.jpeg")
  stackClass.club = love.graphics.newImage("assets/club.jpeg")
  stackClass.diamond = love.graphics.newImage("assets/diamond.jpeg")
